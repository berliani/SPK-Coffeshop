...
class ObjekController extends Controller
{
    ...
    public function index()
    {
        ...
        return view('admin.dashboard.objek.index', [
            "judul" => $judul,
            "data" => $data,
        ]);
    }
    ...
    {
        $data = $this->objekService->simpanPostData($request->validated());
    ...
    {
        $data = $this->objekService->perbaruiPostData($request->validated());
